...
$tutorID = $_POST['tutorID']; // Assuming you get this from a previous page or form

$queryTutor = "SELECT * FROM tutor WHERE TutorID = '$tutorID'";
$resultTutor = $mysqli->query($queryTutor);

$details = $resultTutor->fetch_object();

$sql = "SELECT TutorFirstName, TutorLastName, TutorEmail FROM tutor WHERE TutorID = ? ";

$stmt = mysqli_prepare($mysqli, $sql);
mysqli_stmt_bind_param($stmt, "i", $tutorID);
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $TutorFirstName, $TutorLastName, $TutorEmail);
              ...
              <table class="info-table">
                <tbody>
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <form action="../../credentials/query/edit-tutorquery.php" method="post">
                        <input type="text" name="tutorFirstName" value="<?php echo $TutorFirstName; ?>" required />
                        <input type="text" name="tutorLastName" value="<?php echo $TutorLastName; ?>" required />
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="../../credentials/query/edit-tutorquery.php" method="post">
                        <input type="email" name="email" value="<?php echo $TutorEmail; ?>" required />
                        <input type="hidden" name="tutorID" value="<?php echo $tutorID; ?>" />
                        <button type="submit">Edit</button>
                      </form>
                    </td>

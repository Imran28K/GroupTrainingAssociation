      ...
      <div class="top_navbar">
        ...
        <div class="container">
            ...
            <ul class = 'nav nav-pills nav-stacked' role = 'tablist'>
                <li> <a href='createAccounts/createLearnerAccounts.php'> learner accounts </a> </li>
                <li> <a href='createAccounts/createTutorAccounts.php'> tutor accounts </a> </li>
                <li> <a href='createAccounts/createEmployerAccounts.php'> employer accounts </a> </li>
            </ul>

            <ul class = 'nav nav-pills nav-stacked' role = 'tablist'>
                <li> <a href='createOrUpdateAccount.php'> Back </a> </li>
            </ul>
        </div>
    </div>
</div>
